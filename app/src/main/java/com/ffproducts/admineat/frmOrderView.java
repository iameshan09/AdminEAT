...
public class frmOrderView extends AppCompatActivity {
    ListView myorders;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frm_order_view);
        ...
        adapter=new ArrayAdapter<String>(frmOrderView.this,android.R.layout.simple_spinner_dropdown_item,spinnerdatalist);
